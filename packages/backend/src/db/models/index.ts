...
import { UserProfile, StartedRoomState, UserFeatures, RoleRankings, RoleRating, MiniProgramUser } from '@avalon/types';
...
export const mpUserModel = getModelForClass(MiniProgramUser);
